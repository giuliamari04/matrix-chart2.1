  ...
  return (
    <div className="page tarot-page">
      <section className="page-header">
        <p className="eyebrow">TAROCCHI</p>

        <h1>Esplora gli Arcani</h1>

        <p>Scopri il significato delle carte dei Tarocchi.</p>
      </section>
      ...
      {selectedCard && (
        <div className="modal-overlay" onClick={() => setSelectedCard(null)}>
          ...
          >
            ...
            <p className="eyebrow">{selectedCard.category}</p>
